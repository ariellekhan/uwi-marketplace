            ...
            new Padding(
              ...
              child: new Column(
                ...
                children: <Widget>[
                  ...
                  //favourites
                  new Container(
                      height: 250.0, width: _width, child:new StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                      if (!snapshot.hasData) {
                        ...
                        return ListView.builder(itemBuilder: (context, index) =>
                              buildFavouritesList(context, snapshot.data.documents[index], index),
                  ...
                  new StreamBuilder<QuerySnapshot>(
                    stream: Firestore.instance.collection('users').document(getUser().email).collection("myItems")
                        .snapshots(),
                    builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                      if (!snapshot.hasData) {
                        return Center(
...
Widget buildFavouritesList(BuildContext context, DocumentSnapshot document, index){
          ...
          children: <Widget>[
            ...
            Container(
                ...
                child: ClipRRect(
                  ...
                  child: _favImageUrl == "" ? Image.asset('images/placeholder.png',height: 96.0,
                    width: 96.0,
                    fit: BoxFit.cover,)
                      :CachedNetworkImage(
      ...
      children: <Widget>[
        new Container(
          ...
          width: 72.0,
           child: ClipRRect(
            borderRadius: BorderRadius.circular(4.0),
            child: _itemImageUrl == "" ? Image.asset('images/placeholder.png',height: 96.0,
              width: 96.0,
              fit: BoxFit.cover,)
                :CachedNetworkImage(
